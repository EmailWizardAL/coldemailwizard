...
export default async function handler(req, res) {
  ...
  const prompt = `Write a personalized 7-email cold outreach sequence for ${company.trim()}. Use real recent news, funding, product launches, or LinkedIn activity if possible. Return ONLY valid JSON in this exact format, no markdown or extra text:\n{"emails":[{"subject":"...","body":"..."},{"subject":"...","body":"..."},{"subject":"...","body":"..."},{"subject":"...","body":"..."},{"subject":"...","body":"..."},{"subject":"...","body":"..."},{"subject":"...","body":"..."}]}`;
  ...
  try {
    const response = await fetch('https://openrouter.ai/api/v1/chat/completions', {
      ...
      body: JSON.stringify({
        model: 'openai/gpt-4o',   // ← Best quality, ~$0.02–$0.03 per sequence with your $10
        // model: 'anthropic/claude-3.5-sonnet'   // Alternative if you prefer Claude
